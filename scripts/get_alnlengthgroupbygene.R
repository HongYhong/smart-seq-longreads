...
rep1.alignedlengthgroupbygene = tibble(id = rep1.genome$read,alignedLength = rep1.genome$alignedLength) %>%
...
write.table(rep1.alignedlengthgroupbygene,file = "control_data/rep1.alignedlengthbygene.tsv",sep = "\t",
quote = F,row.names =F,col.names =T)
