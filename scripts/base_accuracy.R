...
rep1.genome = vroom("control_data/rep1.stat.tsv")
...
rep1.baseaccuracy = tibble(id = rep1.genome$read,baseAccuracy = 
(rep1.genome$nbrM+rep1.genome$nbrI+rep1.genome$nbrD-rep1.genome$NM)/
(rep1.genome$nbrM+rep1.genome$nbrI+rep1.genome$nbrD)) %>% 
...
write.table(rep1.baseaccuracy,file = "control_data/rep1.baseaccuracy.tsv",sep = "\t",
quote = F,row.names =F,col.names =T)
